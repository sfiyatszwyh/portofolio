...
<body>
      ...
      <div class="slider_container">
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                        <img src="{{ asset('home/images/slider-img.png') }}" alt="Slider Image" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="carousel_btn-box">
            ...
            <img src="{{ asset('home/images/line.png') }}" alt="Line Image" />
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
                <img src="{{ asset('home/images/saving-img.png') }}" alt="Saving Image" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                    The Best Booktore in the World
                </h2>
              </div>
              <p>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="{{ asset('home/images/gifts.png') }}" alt="Gifts Image" />
              </div>
            </div>
          </div>
          <div class="col-md-7">
  ...
  <!-- client section -->
  <section id="testi" class="client_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          Testimonial
